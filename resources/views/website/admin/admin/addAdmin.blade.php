...
@section('content')
    <div class="bg-[#f5f5f5]">
        <div class="w-full md:ps-24 md:px-10">
            ...
            <form class="w-full" action="{{ route('admin.storeAdmin') }}" method="post">
                @csrf
                    ...
                    <div class="w-full flex flex-wrap ">
                        ...
                        <div class=" w-full md:w-7/12">
                            <div class="w-full mt-10">
                                ...
                                <input class="inputtext fontp" type="text" name="name" placeholder="name"
                                       required/>
                            </div>

                            <div class="w-full mt-4">
                                <p class="font-semibold text-black2 mb-2  text-sm ">E-mail</p>
                                <input class="inputtext fontp" type="email" name="email" placeholder="email" required/>
                            </div>

                            <div class="w-full mt-4">
                                <p class="font-semibold text-black2 mb-2  text-sm ">Phone</p>
                                <input class="inputtext fontp" type="text" name="phone" placeholder="phone"
                                       required/>
                            </div>

                            <div class="w-full mt-4">
                                <p class="font-semibold text-black2 mb-2  text-sm ">Address</p>
                                <input class="inputtext fontp" name="address" placeholder="address" required/>
                            </div>

                            <div class="w-full mt-4">
                                <p class="font-semibold text-black2 mb-2  text-sm ">Password </p>
                                <input class="inputtext fontp" type="password" name="password" placeholder="password"
                                       required/>
                            </div>
                            ...
                            <div class=" w-full mt-4">
                                ...
                                <select class="inputtext " name="state">
                                    <option value="" selected disabled>Select a Wilaya</option>
