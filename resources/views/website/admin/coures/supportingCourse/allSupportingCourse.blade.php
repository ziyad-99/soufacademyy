    ...
    <div>
        <div class="w-full md:ps-24 md:px-10">
            <h4 data-aos="fade-up" class="font-bold text-black34 mx-auto my-5 text-2xl  lg:leading-[120%] ">
                <span>Supporting Courses Panel</span>
            </h4>
                                ...
                                <tr>
                                    ...
                                    <td class="text-sm font-normal leading-normal">
                                        <div class="relative text-sm group justify-end gap-2 flex font-semibold ">
                                            <a href="{{ route('admin.editSupportingCourse', ['course_id' => $course->id]) }}"
                                            ...
                                            <a href="{{ route('admin.deleteSupportingCourse', ['course_id'=>$course->id]) }}" type="button" onclick="openPop('.flexsss24')"
