    ...
    <div>
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl px-4 lg:leading-[120%] ">
                <span>Supporting Courses / Add Course</span>
            </h4>

            <form class="w-full" action="{{ route('admin.storeSupportingCourse') }}" method="post"
                ...
                <div class="  w-full bg-white rounded-2xl p-4  py-10 md:px-9">
                    <div class="w-full flex flex-wrap ">
                        ...
                        <div class=" w-full mt-4">
                            ...
                            <input class="inputtext fontp" name="title_en" placeholder="" required/>
                        </div>

                        <div class=" w-full mt-4">
                            <p class="font-semibold text-black2 mb-2  text-sm ">Course Title (ar)</p>
                            <input class="inputtext fontp" name="title_ar" placeholder="" required/>
                        </div>

                        <div class=" w-full mt-4">
                            <p class="font-semibold text-black2 mb-2  text-sm ">Course Title (fr)</p>
                            <input class="inputtext fontp" name="title_fr" placeholder="" required/>
                        </div>
                        ...
                        <div class=" w-full md:w-6/12 ">
                            <div class=" flex-wrap flex w-full">
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <input class="inputtext fontp" type="text" name="branch_en" placeholder=""
                                           required/>
                                </div>

                                <div class=" w-full mt-4">
                                    <p class="font-semibold text-black2 mb-2  text-sm ">Branch (ar)</p>
                                    <input class="inputtext fontp" type="text" name="branch_ar" placeholder=""
                                           required/>
                                </div>

                                <div class=" w-full mt-4">
                                    <p class="font-semibold text-black2 mb-2  text-sm ">Branch (fr)</p>
                                    <input class="inputtext fontp" type="text" name="branch_fr" placeholder=""
                                           required/>
                                </div>
