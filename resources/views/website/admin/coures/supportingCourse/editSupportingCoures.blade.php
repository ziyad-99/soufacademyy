                    ...
                    <div class="w-full flex flex-wrap ">
                        ...
                        <div class=" w-full mt-4">
                            ...
                            <input class="inputtext fontp" name="title_en"
                                   value="{{ $sup_course->getTranslations()['title']['en'] }}" required/>
                        </div>
                            ...
                            <div class=" flex-wrap flex w-full">
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <select class="inputtext " name="level" required>
                                        ...
                                        <option
                                            value="High School" {{ $sup_course->level === 'High School' ? 'selected' : ''}}>
                                            High School
                                        </option>
                                        <option
                                            value="Secondary School" {{ $sup_course->level === 'Secondary School' ? 'selected' : ''}}>
                                            Secondary School
                                        </option>
                                        <option
                                            value="Primary School" {{ $sup_course->level === 'Primary School' ? 'selected' : ''}}>
                                            Primary School
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <input class="inputtext fontp" type="text" name="frameTime"
                                           value="{{ $sup_course->frameTime }}" placeholder="00:00:00" required/>
                                </div>
                                ...
                                <div class=" w-full mt-4">
                                    ...
                                    <select class="inputtext " name="status" required>
                                        ...
                                        <option value="0" {{ $sup_course->status === 0 ? 'selected' : ''}}>Disable
                                        </option>
                                        <option value="1" {{ $sup_course->status === 1 ? 'selected' : ''}}>Active
                                        </option>
                                    </select>
                                </div>
