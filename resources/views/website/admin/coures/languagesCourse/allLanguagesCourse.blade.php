...
@section('content')
    <div>
        <div class="w-full md:ps-24 md:px-10">
            <h4 data-aos="fade-up" class="font-bold text-black34 mx-auto my-5 text-2xl  lg:leading-[120%] ">
                <span>Language Courses Panel</span>
            </h4>
                    ...
                    <div>
                        <table class="table admin" datatable id="datatable-search-list">
                            ...
                            <tr class="bg-orange/30">
                                ...
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">Title</th>
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">Instructors</th>
                                <th class="font-bold uppercase text-orange text-xxs opacity-70">Level</th>
                            ...
                            @foreach($lang_courses as $course)
                                <tr>
                                    ...
                                    <td class="text-sm font-normal text-black34 fontp leading-normal">
                                        ...
                                        {{--                                        <select class="inputtext w-[250px]" name="Quiz Type" id="QuizSelect">--}}
                                    ...
                                    <td class="text-sm font-normal leading-normal">
                                        <div class="relative text-sm group justify-end gap-2 flex font-semibold ">
                                            <a href="{{ route('admin.editLanguageCourse', ['course_id' => $course->id]) }}"
                                            ...
                                            <a href="{{ route('admin.deleteLanguageCourse', ['course_id'=>$course->id]) }}"
