    ...
    <div>
        ...
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl px-4 lg:leading-[120%] ">
                <span>{{ trans('admin/addIntructors.instructors') }} / {{trans('admin/addIntructors.add_instructor')}}</span>
            </h4>
            <form class="w-full" action="{{ route('admin.storeInstructor') }}" method="post"
                    ...
                    <div class="w-full flex flex-wrap ">
                        <div class=" w-full md:w-7/12 ">
                            ...
                            <div class="w-full mt-10">
                                <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.first_name') }}</p>
                                <input class="inputtext fontp" name="firstName" placeholder="" required/>
                            </div>
                            <div class="w-full mt-5">
                                <p class="font-semibold text-black2 mb-2  text-sm ">{{ trans('admin/addIntructors.last_name') }}</p>
