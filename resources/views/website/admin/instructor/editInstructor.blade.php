    ...
    <div>
        ...
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl px-4 lg:leading-[120%] ">
                <span>Instructors / Edit Instructor</span>
            </h4>
            <form class="w-full" action="{{ route('admin.updateInstructorProfile') }}" method="post"
                  enctype="multipart/form-data">
                @csrf
                <input name="instructor_id" hidden required value="{{ $instructor->id }}"/>
                    ...
                    <div class="w-full flex flex-wrap ">
                        <div class=" w-full md:w-7/12 ">
                            ...
                            <div class="w-full mt-10">
                                ...
                                <input class="inputtext fontp" type="text" name="firstName" placeholder="" required
                            ...
                            <div class=" flex-wrap flex w-full mt-4">
                                <div class="w-full md:w-6/12 pe-2">
                                    ...
                                    <select class="inputtext " name="state">
                                        <option value="{{ $instructor->state }}" selected>select state</option>
...
{{--                                </div>--}}
                            ...
                            <div class=" w-full mt-4">
                                ...
                                <select class="inputtext " name="gender">
                                    ...
                                    <option value="male" {{ $instructor->gender === 'male' ? 'selected' : ''}}>Male
                                    </option>
                                    <option value="female" {{ $instructor->gender === 'female' ? 'selected' : ''}}>Female
                                    </option>
                                </select>
                            </div>
                    ...
                    <button type="submit"
                            class=" btn items-center hover:bg-orange3 transform hover:scale-105 ms-0 mt-5 flex px-10">
                        <span class=" text-white font-bold text-sm ">Edit</span>
                    </button>
                </div>
            </form>
        </div>
