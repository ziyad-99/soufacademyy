    ...
    <div>
        ...
        <div class="w-full md:ps-24 md:px-10">
            <h4 class="font-bold text-black34 mx-auto my-5 text-2xl px-4 lg:leading-[120%] ">
                <span>Students / Edit Student</span>
            </h4>
            <form class="w-full" action="{{ route('admin.updateStudentProfile') }}" method="post"
                  enctype="multipart/form-data">
                @csrf
                <input name="student_id" hidden required value="{{ $student->id }}"/>
                            ...
                            <div class=" flex-wrap flex w-full mt-4">
                                <div class="w-full md:w-6/12 pe-2">
                                    ...
                                    <select class="inputtext " name="state">
                                        <option value="{{ $student->state }}" selected>select state</option>
