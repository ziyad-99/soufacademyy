                    ...
                    @forelse($sessions as $session)
                        <div class="flex items-center p-6 border-b border-[#E2E2E2]/50 border-solid">
                            ...
                            <div class="w-6/12 md:w-3/12 ms-auto">
                                <a href="{{ route('instructor.resource', ['session_id' => $session->id]) }}"
                                   class="w-full  md:w-40 btn bg-orange hover:bg-orange cursor-pointer items-center justify-center flex px-6">
                                    <span class=" text-white font-bold text-sm ">Add Resources</span>
                                </a>
                            </div>
                        </div>
                    @empty
                            ...
                            <div class=" w-6/12 flex flex-wrap items-center">
                                <div class="md:px-6 pt-4 md:pt-0">
                                    <h5 class="text-lg font-semibold text-black2  hover:text-orange  transition-all">
                                        There are no sessions on this Course !!!!
                                    </h5>
                                </div>
                            </div>
                        </div>
