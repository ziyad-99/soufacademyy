                        ...
                        <div id="tab-contents2">
                            <div id="first" class="  p-6 bg-[#f5f5f5] border rounded border-[#eee] ">
                                <div title="Resources" class="w-full">
                                    @forelse($course->sessions->last()->ressources as $ressource)
                            ...
                            <div id="second" title="Quiz"
                                ...
                                <div class="min-w-[600px]">
                                    ...
                                    @forelse($lastSession->quizs as $quiz)
                            ...
                            <div id="third" class="hidden w-full">
                                ...
                                <div class="w-full pt-10  pb-10 flex justify-between">
                                    ...
                                    <div class="w-10/12 lg:w-11/12 ">
                                            <textarea
                                                class="bg-gray/10 rounded-[15px] px-4 fontp w-full mt-3 font-medium border border-[#DFDFDF] placeholder-slate-400 focus:outline-none focus:border-orange focus:ring-orange3/50 block sm:text-sm focus:ring-1  min-h-[250px] h-auto py-3"
