...
<div>
    <section class="flex flex-wrap widthfull pt-6">
        <div class="order-2 md:order-1 w-full lg:w-7/12">
            <h1 class=" mt-16 text-black text-3xl md:text-5xl font-bold leading-[112%] lg:leading-[120%] lg:text-6xl">
                <span class="text-orange block">{{ trans('website/welcome.souf_academy') }}</span>{{ trans('website/welcome.Platform_online') }}
            </h1>
            ...
            <a href="{{ route('student.mycourse') }}" class=" w-40 btn items-center justify-center   hover:text-orange hover:bg-orange3 transform hover:scale-[1.01] transition-all flex px-6">
                <span class=" text-white font-bold text-sm ">{{ trans('website/welcome.my_courses') }}</span>
            </a>
        </div>
        <div class="order-1 md:order-2 w-full lg:w-5/12">

            <img class=" object-contain mx-auto lg:-ms-[10%] z-[0] w-[90%] lg:w-[120%] " src="{{ URL::asset('website/images/souf1.webp') }}" alt="Souf Academy" />
        </div>
    ...
    <div class="flex flex-wrap my-20 gap-6 widthfull justify-center items-center">
        <div class="rounded-xl bg-white flex flex-col  boxshadow2 p-4">
            <img class=" object-contain mx-auto h-9 " src="{{ URL::asset('website/images/logo33.png') }}" alt="logo" />
...
<div class="bg-[#f5f5f5] -mt-14">
    <svg class="w-full h-auto" width="1440" height="98" viewBox="0 0 1440 98" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="bg-white">
    <div class="widthfull  bg-white  pt-10">
        ...
        @else
        <div class="grid gap-4 md:gap-[5px] pt-10  bg-white items-stretch grid-cols-1 md:grid-cols-4 relative  ">
            ...
            <div data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000" class="w-full px-2">
                <div class="course-item w-full ww rounded-xl bg-white">
                    <div class="course-img-wrap overflow-hidden">
                        <a href="#"><img src="{{ asset('images/courses/'.$course->img) }}" alt="course" class="img-fluid imgc"></a>
                    </div>
                    <div class="card-body">
                        <h5 class="text-lg font-semibold hover:text-orange text-orange2"><a class="hover:text-orange" href="#">{{ Str::limit($course->title, 20, '...') }}</a>
                        </h5>
                    ...
                    <a href="{{ route('intensive_course.details', ['slug' => $course->slug]) }}" class=" w-full btn-big cursor-pointer bg-orange hover:bg-orange3 items-center justify-center flex px-6">
...
<div class=" bg-white w-full pt-16 ">
    <div class=" relative h-20  overflow-hidden">
        <img class=" object-contain -mb-8 lg:-mb-12 text2 h-8 lg:h-12" src="{{ URl::asset('website/images/souf.svg') }}" />
        <img class=" object-contain -mt-0 text3  h-8 lg:h-12 ms-2" src="{{ URL::asset('website/images/souf.svg') }}" />
    </div>

    <div class="widthfull pb-6 pt-10 mt-10">
        <div class=" flex w-full justify-between">
            <h3 class=" font-bold text-2xl md:text-3xl">{{ trans('website/welcome.language') }}</h3>
            <a href="{{ route('all_languages_courses.index') }}" class="flex justify-center bg-orange  hover:text-orange hover:bg-orange3 transform hover:scale-[1.01] transition-all rounded-xl px-4 py-2 items-center">
                <span class="text-sm md:text-base text-white fontp font-medium">{{ trans('website/welcome.view_all') }}</span>
                <svg class="transform  rtl:-scale-100 w-[6px] md:w-[6px] ms-2" width="10" height="17" viewBox="0 0 10 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 2L7.5118 7.35101C8.16273 7.98295 8.16273 9.01704 7.5118 9.64899L2 15" stroke="#fff" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
        ...
        <div class=" relative w-full mt-8 flex">
            <div class="slider2 slider-nav5 sdsds w-full" style="color: #000;" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                ...
                <div data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000" class="w-full px-2">
                    <div class="course-item w-full ww rounded-xl bg-white">
                        ...
                        <div class="card-body">
                            <h5 class="text-lg font-semibold hover:text-orange text-orange2"><a class="hover:text-orange" href="#"> </a></h5>
                            <div class="instructor-bottom-item mt-1 text-base font-semibold">
                        ...
                        <a href="{{ route('languages_course.details', ['slug' => $course->slug]) }}" class=" w-full btn-big cursor-pointer bg-orange hover:bg-orange3 items-center justify-center flex px-6">
                            <span class=" text-white font-bold text-sm ">{{ trans('website/welcome.more_details') }}</span>
                        </a>
                    </div>
                </div>
    ...
    <div class=" bg-gray4 w-full">
        <svg class=" w-full  h-auto" width="1439" height="174" viewBox="0 0 1439 174" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M1439 0H0V76V112.812C285.013 65.5532 951.241 97.3909 1439 174V76V0Z" fill="white" />
        </svg>
    </div>
    ...
    <div class="  bg-gray4 w-full  ">
        <div class="widthfull pt-4 pb-6 ">
            <div class=" flex w-full   justify-between">
                ...
                <a href="{{ route('all_intensive_courses.index') }}" class="flex justify-center bg-orange  hover:text-orange hover:bg-orange3 transform hover:scale-[1.01] transition-all rounded-xl px-4 py-2 items-center">
                    <span class="text-sm md:text-base text-white fontp font-medium">{{ trans('website/welcome.view_all') }}</span>
                    <svg class="transform  rtl:-scale-100 w-[6px] md:w-[6px] ms-2" width="10" height="17" viewBox="0 0 10 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 2L7.5118 7.35101C8.16273 7.98295 8.16273 9.01704 7.5118 9.64899L2 15" stroke="#fff" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
    ...
    <div class=" bg-white w-full h-full text-center  ">
        ...
        <section class=" bg-[#f5f5f5] py-20   px-4">
            ...
            <div class=" px-0 md:px-5 pt-10 items-stretch relative widthfull ">
                <div class="slider2 slider-nav4 sdsds" style="color: #000;" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">

                    <div class="card mx-3 rounded-[10px]">
                        <img class="h-[40px]  me-auto object-contain" src="{{ URL::asset('website/images/comme.svg') }}" />
                        ...
                        <div class=" flex items-center mt-4">
                            <div class=" h-[50px] w-[50px] rounded-full overflow-hidden">
                                <img class="h-full w-full object-cover" src="{{ URL::asset('website/images/man.png') }}" />
                            </div>
                            <div class=" ps-4">
        ...
        <div class=" widthfull ">
            ...
            <div class="grid gap-4 md:gap-[20px] pt-10  bg-white items-stretch grid-cols-1 md:grid-cols-3 relative  ">
                <div class="card ">
                    <img class="h-[66px] mt-5 ms-4 object-contain" src="{{ URL::asset('website/images/analeys.svg') }}" />
                ...
                <div class="card ">
                    <img class="h-[66px] mt-5 ms-4 object-contain" src="{{ URL::asset('website/images/AlgeriePoste.svg') }}" />
            ...
            <div class=" flex my-10 justify-center items-center">
                <a href="{{ route('student.subscription') }}" class=" w-40 btn items-center justify-center flex px-6">
            ...
            <ul id="tabs3" class="inline-flex gap-2 flex-wrap justify-center pt-2 px-1 w-full">
                <li class="bg-orange/20 border border-[#8e8e8e21] h-12 flex items-center  rounded-xl">
                    <a id="default-tab" class="text-orange w-full text-center h-full px-3 md:px-8  font-semibold py-3 " href="#first">{{ trans('website/welcome.language') }}</a>
                </li>
                <li class=" border mx-2 border-[#8e8e8e21] h-12 flex items-center  rounded-xl">
                    <a id="default-tab" class="w-full text-center h-full px-3 md:px-8  font-semibold py-3 " href="#second">{{ trans('website/welcome.supporting') }}</a>
                </li>
                <li class="border mx-2  border-[#8e8e8e21] h-12 flex items-center  rounded-xl">
                    <a id="default-tab" class=" w-full text-center h-full px-3 md:px-8  font-semibold py-3 " href="#third">{{ trans('website/welcome.intensive') }}</a>
                </li>
                        ...
                        <div class=" w-full p-4 pt-10" id="first">
                            <div class=''>
                                <div class="w-full md:w-8/12 mx-auto boxx   mb-6">
                                    ...
                                    <!-- start for -->
                                    <div data-aos="fade-up" accordion-section class="bg-white mt-5 relative rounded-xl  cursor-pointer boxshadow3">
                                        <h5 class="mb-0">
                                        ...
                                        <div section-content class="overflow-hidden transition-all ease-in-out duration-350">
                                            <div class="fontp px-7 pb-7  text-start text-gray2 font-normal text-[15px] lg:leading-[140%] ">
            ...
            <div class="mx-auto relative boxshadow z-10 flex-wrap items-center rounded-[10px] w-11/12 md:w-6/12 mt-40 -mb-10 bg-white p-8 flex">
            <p class="fontp text-black2 w-full md:w-8/12 font-bold text-xl leading-[136%]  text-start">
                    {{ trans('website/welcome.we_help') }}
                </p>

                <a href="{{ route('student.subscription') }}" class=" w-44 btn items-center justify-center  hover:text-orange hover:bg-orange3 transform hover:scale-[1.01] transition-all flex mx-auto mt-2 md:mt-0 md:me-auto md:ms-3 px-6">
